...
get_salary_wages
# Ensure that salary_wages data has 22 points
...
# If you need exactly 22 observations, you can either take the first 22, sample 22 randomly, or apply some selection method.
# Randomly select 22 observations from the combined data
set.seed(123)  # For reproducibility
salary_wages_sample_22 <- sample(salary_wages_sample, 22, replace = FALSE)
salary_wages_sample_22
# View the sample of 22 observations
print(salary_wages_sample_22)
...
# If you want to take exactly 22 samples, you can sample from combined data
set.seed(123)  # For reproducibility
salary_wages_sample_22 <- sample(combined_salary_wages, 22, replace = FALSE)

# Get frequency distribution for the sample data
frequency_distribution_sample <- get_frequency_distribution(salary_wages_sample_22)

# Print the frequency distribution for the sample
cat("Frequency Distribution for Sample of 22 Observations:\n")
...
# Perform analysis on the 22 sample
print_analysis(salary_wages_sample_22, "Salary Wages Sample of 22 Observations")
